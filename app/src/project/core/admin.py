...
class SolutionEvaluationAdmin(admin.ModelAdmin):
    ...
    search_fields = (
        "judgement__sender__hotkey",
        "judgement__miner__hotkey",
        "judgement__validator__hotkey",
    )
    autocomplete_fields = (
        "sender",
        "judgement",
    ...
    def get_queryset(self, request: HttpRequest) -> QuerySet:
        return (
            ...
            .select_related("judgement__sender", "judgement__miner", "judgement__validator", "evaluation_type")
        )
